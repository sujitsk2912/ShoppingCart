<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HomeLeavingSection.aspx.cs" Inherits="ShoppingCart_Application.Home_LeavingSection" %>
    ...
    <body>
      ...
      <!-- start of carousel section -->
	        ...
	        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="4000">	
		        ...
		        <div class="carousel-inner">
			       <div class="carousel-item active">
                        <img src="Home&Leaving_bg/HL1.gif" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Home&Leaving_bg/HL2.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Home&Leaving_bg/HL3.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Home&Leaving_bg/HL4.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Home&Leaving_bg/HL5.jpg" alt="" >
                    </div>
		        </div>
        ...
        <!--end of carousel section -->
               ...
               <div>
         <br />
        <h2 class="newStyle5" style="text-align: center; font-weight:700; padding:15px; background-color:#93d6f77e">Home & Leaving</h2>
                ...
                <td style="width:100%">
                  ...
                  <tr width="100%">
                            ...
                            <td  align="center" valign="top">
                                ...
                                <img id="Img1" alt='<%#Eval("ProductImage")%>' src='<%# "/Product_Images/" + Eval("ProductImage","{0}")%>' style="border-width:0; padding:10px 0" height="250"  runat="server" />
                                </a> 
                            </td>
                        </tr>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Shopping_CartConnectionString %>" SelectCommand="SELECT * FROM [Home_Leaving_Products]"></asp:SqlDataSource>
