<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BeautySection.aspx.cs" Inherits="ShoppingCart_Application.BeautySection" %>
    ...
    <body>
      ...
      <!-- start of carousel section -->
	        ...
	        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="4000">	
		        ...
		        <div class="carousel-inner">
			        <div class="carousel-item active">
				        <img src="Beauty_bg/bg1.png" alt="" >
			        </div>
			        <div class="carousel-item">
				        <img src="Beauty_bg/bg2.png" alt="" >
			        </div>
                    <div class="carousel-item">
                        <img src="Beauty_bg/bg4.png" alt="" >
                    </div>
		        </div>
        ...
        <!--end of carousel section -->
               ...
               <div>
         <br />
        <h2 class="newStyle5" style="text-align: center; font-weight:700; padding:15px; background-color:#93d6f77e; letter-spacing:2px">Beauty Product's</h2>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Shopping_CartConnectionString %>" SelectCommand="SELECT * FROM [Beauty_Products]"></asp:SqlDataSource>
