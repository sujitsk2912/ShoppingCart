<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="ShoppingCart_Application.HomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="margin-top:2%">
        <asp:Image ID="Image5" runat="server" ImageUrl="~/20%off.png" Width="100%"/>
    </div>
			...
			<div id="demo" class="carousel slide" data-ride="carousel" data-interval="4000">	
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="Home_bg/bg1.jpg" alt="" >
					</div>
					<div class="carousel-item">
						<img src="Home_bg/bg2.jpg" alt="" >
					</div>
					<div class="carousel-item">
						<img src="Home_bg/bg3.jpg" alt="" >
					</div>
                    <div class="carousel-item">
                        <img src="Home_bg/bg4.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Home_bg/bg5.jpg" alt="" >
                    </div>
				</div>
        ...
        <div>
             <br />
            <h2 class="newStyle5" style="text-align: center; font-weight:700; padding:15px; background-color:#93d6f77e; letter-spacing:2px">Today's Deals</h2>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Shopping_CartConnectionString %>" SelectCommand="SELECT * FROM [Product_Table]"></asp:SqlDataSource>
