<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WomenSection.aspx.cs" Inherits="ShoppingCart_Application.WebForm1" %>
    ...
    <body>
      ...
      <!-- start of carousel section -->
	        ...
	        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="4000">	
		        ...
		        <div class="carousel-inner">
			        <div class="carousel-item active">
				        <img src="Womens_bg/wbg1.png" alt="" >
			        </div>
			        <div class="carousel-item">
				        <img src="Womens_bg/wbg2.png" alt="" >
			        </div>
			        <div class="carousel-item">
				        <img src="Womens_bg/wbg3.png" alt="" >
			        </div>
                    <div class="carousel-item">
                        <img src="Womens_bg/wbg4.png" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Womens_bg/wbg5.png" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Womens_bg/wbg6.png" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Womens_bg/wbg7.png" alt="" >
                    </div>
		        </div>
        ...
        <!--end of carousel section -->
            ...
            <div>
                <br />
        <h2 class="newStyle5" style="text-align: center; font-weight:700; padding:20px; background-color:#93d6f77e; letter-spacing:2px">Women's Wear</h2>
                ...
                <td style="width:100%">
                  ...
                  <tr width="100%">
                            ...
                            <td  align="center" valign="top">
                                ...
                                <img id="Img1" alt='<%#Eval("ProductImage")%>' src='<%# "/Product_Images/" + Eval("ProductImage","{0}")%>' style="border-width:0; padding:10px 0" height="280"  runat="server" />
                                </a> 
                            </td>
                        </tr>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Shopping_CartConnectionString %>" SelectCommand="SELECT * FROM [Womens_Products]"></asp:SqlDataSource>
