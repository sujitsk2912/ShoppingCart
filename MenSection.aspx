<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MenSection.aspx.cs" Inherits="ShoppingCart_Application.MenPage" %>
    ...
    <body>
      ...
      <!-- start of carousel section -->
	        ...
	        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="4000">	
		        ...
		        <div class="carousel-inner">
			        <div class="carousel-item active">
				        <img src="Mens_bg/mbg1.png" alt="" >
			        </div>
			        <div class="carousel-item">
				        <img src="Mens_bg/mbg2.png" alt="" >
			        </div>
			        <div class="carousel-item">
				        <img src="Mens_bg/mbg3.png" alt="" >
			        </div>
                    <div class="carousel-item">
                        <img src="Mens_bg/mbg4.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Mens_bg/mbg5.png" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Mens_bg/mbg6.jpg" alt="" >
                    </div>
                    <div class="carousel-item">
                        <img src="Mens_bg/mbg7.png" alt="" >
                    </div>
		        </div>
        ...
        <!--end of carousel section -->
               ...
               <div>
         <br />
        <h2 class="newStyle5" style="text-align: center; font-weight:700; padding:15px; background-color:#93d6f77e; letter-spacing:2px">Men's Wear</h2>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Shopping_CartConnectionString %>" SelectCommand="SELECT * FROM [Mens_Products]"></asp:SqlDataSource>
